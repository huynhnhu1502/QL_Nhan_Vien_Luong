...
namespace WinForms {
    ...
    public partial class QuanLyLuongDataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public NhanVienRow AddNhanVienRow(string MaNV, string HoTen, string MaDonVi, string MaChucVu) {
...
namespace WinForms.QuanLyLuongDataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NhanVien] WHERE (([id] = @Original_id) AND ([MaNV] = @Original" +
                "_MaNV) AND ([HoTen] = @Original_HoTen) AND ([MaDonVi] = @Original_MaDonVi) AND (" +
                "[MaChucVu] = @Original_MaChucVu))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [MaNV] = @MaNV, [HoTen] = @HoTen, [MaDonVi] = @MaDonVi, [MaChucVu] = @MaChucVu WHERE (([id] = @Original_id) AND ([MaNV] = @Original_MaNV) AND ([HoTen] = @Original_HoTen) AND ([MaDonVi] = @Original_MaDonVi) AND ([MaChucVu] = @Original_MaChucVu));
SELECT id, MaNV, HoTen, MaDonVi, MaChucVu FROM NhanVien WHERE (MaNV = @MaNV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, MaNV, HoTen, MaDonVi, MaChucVu FROM dbo.NhanVien";
        ...
        public virtual int Delete(int Original_id, string Original_MaNV, string Original_HoTen, string Original_MaDonVi, string Original_MaChucVu) {
        ...
        public virtual int Update(string MaNV, string HoTen, string MaDonVi, string MaChucVu, int Original_id, string Original_MaNV, string Original_HoTen, string Original_MaDonVi, string Original_MaChucVu) {
            if ((MaNV == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTen, string MaDonVi, string MaChucVu, int Original_id, string Original_MaNV, string Original_HoTen, string Original_MaDonVi, string Original_MaChucVu) {
            return this.Update(Original_MaNV, HoTen, MaDonVi, MaChucVu, Original_id, Original_MaNV, Original_HoTen, Original_MaDonVi, Original_MaChucVu);
        }
    }
